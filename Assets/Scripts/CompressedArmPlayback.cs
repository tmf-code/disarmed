...
public class CompressedArmPlayback : MonoBehaviour
{
  ...
  [NonSerialized] public List<string> names = MovementNames.names;

  public int recordingIndex = 0;
  [ShowOnly] public string recordingName = MovementNames.names[0];
  ...
  private CompressedArmRecording recording;
  ...
  public void LoadRecording()
  {
...
#endif
    recordingName = names[recordingIndex];
    ...
    recording = JsonUtility.FromJson<CompressedArmRecording>(textAsset.text);
  }
