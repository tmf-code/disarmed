...
{
  public static Quaternion Clamp(this Quaternion quaternion, Vector3 lowerBound, Vector3 upperBound)
  {
    var rotationAxis = new float[] { quaternion.x, quaternion.y, quaternion.z };
    var w = quaternion.w;


    var resultComponents = rotationAxis.Select((component, index) =>
    {
    ...
    var result = new Quaternion(resultComponents[0], resultComponents[1], resultComponents[2], 1);
