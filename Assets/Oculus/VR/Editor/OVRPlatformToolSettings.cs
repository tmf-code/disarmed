...
namespace Assets.Oculus.VR.Editor
{
  ...
  public sealed class OVRPlatformToolSettings : ScriptableObject
  {
    ...
    public static string AppID
    {
      ...
      {
        if (
            Instance.targetPlatform < OVRPlatformTool.TargetPlatform.None
            && EditorPrefs.HasKey(
                "OVRPlatformToolSettings_AppID" + (int)Instance.targetPlatform
            )
        )
        {
    ...
    public static string ReleaseNote
    {
      get
      {
        if (
            Instance.targetPlatform < OVRPlatformTool.TargetPlatform.None
            && EditorPrefs.HasKey(
                "OVRPlatformToolSettings_ReleaseNote" + (int)Instance.targetPlatform
            )
        )
        {
          return EditorPrefs.GetString(
    ...
    public static string ApkBuildPath
    {
      get
      {
        if (
            Instance.targetPlatform < OVRPlatformTool.TargetPlatform.None
            && EditorPrefs.HasKey(
                "OVRPlatformToolSettings_ApkBuildPath" + (int)Instance.targetPlatform
            )
        )
        {
          return EditorPrefs.GetString(
    ...
    public static string ObbFilePath
    {
      get
      {
        if (
            Instance.targetPlatform < OVRPlatformTool.TargetPlatform.None
            && EditorPrefs.HasKey(
                "OVRPlatformToolSettings_ObbFilePath" + (int)Instance.targetPlatform
            )
        )
        {
          return EditorPrefs.GetString(
    ...
    public static string AssetsDirectory
    {
      get
      {
        if (
            Instance.targetPlatform < OVRPlatformTool.TargetPlatform.None
            && EditorPrefs.HasKey(
                "OVRPlatformToolSettings_AssetsDirectory" + (int)Instance.targetPlatform
            )
        )
        {
          return EditorPrefs.GetString(
    ...
    public static List<AssetConfig> AssetConfigs
    {
      get
      {
        return Instance.targetPlatform < OVRPlatformTool.TargetPlatform.None
    ...
    public static bool UploadDebugSymbols
    {
      ...
      set { EditorPrefs.SetBool("OVRPlatformToolSettings_UploadDebugSymbols", value); }
    }
    ...
    public static bool UploadDebugSymbolsOnly
    {
      ...
      set { EditorPrefs.SetBool("OVRPlatformToolSettings_UploadDebugSymbolsOnly", value); }
    }
    ...
    public static string BuildID
    {
      ...
      set { EditorPrefs.SetString("OVRPlatformToolSettings_BuildID", value); }
    }
    ...
    [SerializeField]
    private AssetConfigList[] assetConfigs = new AssetConfigList[
        (int)OVRPlatformTool.TargetPlatform.None
    ];
      ...
      get
      {
        if (instance == null)
        {
          ...
          if (instance == null)
          {
            ...
            string properPath = System.IO.Path.Combine(
            ...
            if (instance != null)
            {
              ...
              {
                EditorPrefs.SetString(
                    "OVRPlatformToolSettings_ReleaseChannel" + i,
