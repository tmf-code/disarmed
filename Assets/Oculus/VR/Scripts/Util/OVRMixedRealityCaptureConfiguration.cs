...
public static class OVRMixedRealityCaptureConfigurationExtensions
{
  public static void ApplyTo(
      this OVRMixedRealityCaptureConfiguration dest,
  ...
  )
  {
    ...
    dest.dynamicLightingDepthVariationClampingValue =
        source.dynamicLightingDepthVariationClampingValue;
    ...
    dest.instantiateMixedRealityCameraGameObject =
        source.instantiateMixedRealityCameraGameObject;
  }
}
#endif
