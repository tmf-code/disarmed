...
public class OVRDebugInfo : MonoBehaviour
{
  ...
  void InitUIComponents()
  {
    ...
    {
      resolutionEyeTexture = VariableObjectManager(
          resolutionEyeTexture,
          "Resolution",
          posY -= offsetY,
          strResolutionEyeTexture,
          fontSize
      );
    }
    ...
    {
      latencies = VariableObjectManager(
          latencies,
          "Latency",
          posY -= offsetY,
          strLatencies,
  ...
  GameObject VariableObjectManager(
  ...
  void UpdateFOV()
  {
    OVRDisplay.EyeRenderDesc eyeDesc = OVRManager.display.GetEyeRenderDesc(
        UnityEngine.XR.XRNode.LeftEye
    );
  ...
  {
    OVRDisplay.EyeRenderDesc leftEyeDesc = OVRManager.display.GetEyeRenderDesc(
        UnityEngine.XR.XRNode.LeftEye
    );
    OVRDisplay.EyeRenderDesc rightEyeDesc = OVRManager.display.GetEyeRenderDesc(
        UnityEngine.XR.XRNode.RightEye
    );
    ...
    float h = (int)(
        scale * (float)Mathf.Max(leftEyeDesc.resolution.y, rightEyeDesc.resolution.y)
    );
  ...
  void UpdateLatencyValues()
  {
    ...
    if (
        latency.render < 0.000001f
        && latency.timeWarp < 0.000001f
        && latency.postPresent < 0.000001f
    )
