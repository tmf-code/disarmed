...
public class OVRControllerHelper : MonoBehaviour
{
  ...
  void Start()
  {
    ...
    Debug.LogFormat(
        "OVRControllerHelp: Active controller type: {0} for product {1}",
  ...
  void Update()
  {
    ...
    if (m_animator != null)
    {
      m_animator.SetFloat(
          "Button 1",
          OVRInput.Get(OVRInput.Button.One, m_controller) ? 1.0f : 0.0f
      );
      m_animator.SetFloat(
          "Button 2",
          OVRInput.Get(OVRInput.Button.Two, m_controller) ? 1.0f : 0.0f
      );
      m_animator.SetFloat(
          "Button 3",
          OVRInput.Get(OVRInput.Button.Start, m_controller) ? 1.0f : 0.0f
      );
