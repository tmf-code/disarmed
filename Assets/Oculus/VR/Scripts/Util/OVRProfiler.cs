...
public class OVRProfiler : EditorWindow
{
  ...
  void OnGUI()
  {
    ...
    string[] options = new string[] { "Oculus Quest", "Oculus Rift", };
    mTargetPlatform = (TargetPlatform)EditorGUILayout.Popup(
  ...
  void DrawResults()
  {
    ...
    foreach (RangedRecord record in mRecords)
    {
      ...
      EditorGUI.ProgressBar(
          r,
          record.value / (record.max * 2),
          record.category + " " + record.value.ToString()
      );
      GUILayout.Space(16);
  ...
  private void UpdateRecords()
  {
    ...
    else
    {
      ...
      AddRecord(
          "Graphics Memory (MB)",
          "Please use less than 1024 MB of vertex and texture memory.",
          ConvertBytes(memSizeByte, "MB"),
          0,
          1024
      );
    }
    ...
    AddRecord(
        "Triangles",
        "Please use less than 100000 triangles.",
    ...
    AddRecord(
        "Vertices",
        "Please use less than 100000 vertices.",
        UnityStats.vertices,
        0,
        triVertRec
    );
    ...
    AddRecord(
        "Draw Call",
        "Please use less than 100 draw calls.",
