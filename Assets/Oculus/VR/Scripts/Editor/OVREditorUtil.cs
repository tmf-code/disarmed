...
public static class OVREditorUtil
{
  ...
  public static void SetupBoolField(
      Object target,
      string name,
      ref bool member,
      ref bool modified
  ...
  public static void SetupIntField(
      Object target,
      GUIContent name,
      ref int member,
      ref bool modified
  ...
  public static void SetupFloatField(
      Object target,
      string name,
      ref float member,
      ref bool modified
  ...
  public static void SetupDoubleField(
      Object target,
      string name,
      ref double member,
      ref bool modified
  ...
  public static void SetupColorField(
      Object target,
      string name,
      ref Color member,
      ref bool modified
  ...
  public static void SetupLayerMaskField(
      Object target,
      string name,
      ref LayerMask layerMask,
      string[] layerMaskOptions,
      ref bool modified
  )
  {
    SetupLayerMaskField(
  ...
  public static void SetupEnumField<T>(
      Object target,
      string name,
      ref T member,
      ref bool modified,
  ...
  public static void SetupInputField(
      Object target,
      string name,
      ref string member,
      ref bool modified
  ...
  public static void SetupTexture2DField(
      Object target,
      string name,
      ref Texture2D member,
      ref bool modified
  )
  {
  ...
  {
    EditorGUI.BeginChangeCheck();
    Texture2D value = (Texture2D)EditorGUILayout.ObjectField(
        name,
        member,
        typeof(Texture2D),
        false
