...
public class OVRProjectConfigEditor : Editor
{
  ...
  public static void DrawTargetDeviceInspector(OVRProjectConfig projectConfig)
  {
    ...
    EditorGUILayout.LabelField("Configure Target Devices in Oculus XR Plugin Settings.");
        ...
        foreach (
            OVRProjectConfig.DeviceType deviceType in System.Enum.GetValues(
            ...
            OVREditorUtil.SetupBoolField(
                projectConfig,
                ObjectNames.NicifyVariableName(deviceType.ToString()),
                ref newSupportsDevice,
                ref hasModified
            );
  ...
  public static void DrawProjectConfigInspector(OVRProjectConfig projectConfig)
  {
    ...
    OVREditorUtil.SetupEnumField(
        projectConfig,
        "Hand Tracking Support",
        ref projectConfig.handTrackingSupport,
        ref hasModified
    );
    ...
    OVREditorUtil.SetupEnumField(
        ...
        ref projectConfig.handTrackingFrequency,
        ref hasModified,
        "https://developer.intern.oculus.com/documentation/unity/unity-handtracking/#enable-hand-tracking"
    );
    ...
    OVREditorUtil.SetupBoolField(
        projectConfig,
        new GUIContent(
            "Allow Optional 3DoF Head Tracking",
        ...
        ref projectConfig.allowOptional3DofHeadTracking,
        ref hasModified
    );
    ...
    OVREditorUtil.SetupBoolField(
        ...
        ref projectConfig.skipUnneededShaders,
        ref hasModified
    );
    ...
    OVREditorUtil.SetupInputField(
        projectConfig,
        "Custom Security XML Path",
        ref projectConfig.securityXmlPath,
        ref hasModified
    );
    OVREditorUtil.SetupBoolField(
        projectConfig,
        "Disable Backups",
        ref projectConfig.disableBackups,
        ref hasModified
    );
    OVREditorUtil.SetupBoolField(
        projectConfig,
        "Enable NSC Configuration",
        ref projectConfig.enableNSCConfig,
        ref hasModified
    );
    ...
    OVREditorUtil.SetupBoolField(
        ...
        ref projectConfig.insightPassthroughEnabled,
        ref hasModified
    );
    EditorGUI.EndDisabledGroup();
