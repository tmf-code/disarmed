...
namespace OculusSampleFramework
{
  public class WindmillBladesController : MonoBehaviour
  {
    ...
    [SerializeField]
    private AudioClip _windMillRotationSound = null;
    [SerializeField]
    private AudioClip _windMillStartSound = null;
    [SerializeField]
    private AudioClip _windMillStopSound = null;
    ...
    private void Update()
    {
      ...
      transform.localRotation =
          _originalRotation * Quaternion.AngleAxis(_rotAngle, Vector3.forward);
    }
    ...
    private IEnumerator LerpToSpeed(float goalSpeed)
    {
      ...
      if (IsMoving)
      {
        _audioChangeCr = StartCoroutine(
            PlaySoundDelayed(
                _windMillStartSound,
                _windMillRotationSound,
                _windMillStartSound.length * 0.95f
            )
        );
      } // stop
      else
