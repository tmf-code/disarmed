...
namespace OculusSampleFramework
{
  public class TrainTrack : MonoBehaviour
  {
    ...
    [SerializeField]
    private Transform _segmentParent = null;
    [SerializeField]
    private Transform _trainParent = null;
    // regeneration is optional
    [SerializeField]
    private bool _regnerateTrackMeshOnAwake = false;
    ...
    public TrackSegment GetSegment(float distance)
    {
      ...
      for (int i = 0; i < childCount; i++)
      {
        ...
        if (
            ...
            && (distance < nextSegment.StartDistance || i == childCount - 1)
        )
        {
          return segment;
        }
