...
namespace OculusSampleFramework
{
  public class TrainLocomotive : TrainCarBase
  {
    ...
    [SerializeField]
    private GameObject _decreaseSpeedButton = null;
    [SerializeField]
    private GameObject _increaseSpeedButton = null;
    [SerializeField]
    private GameObject _smokeButton = null;
    [SerializeField]
    private GameObject _whistleButton = null;
    [SerializeField]
    private GameObject _reverseButton = null;
    [SerializeField]
    private AudioSource _whistleAudioSource = null;
    [SerializeField]
    private AudioClip _whistleSound = null;
    [SerializeField]
    private AudioSource _engineAudioSource = null;
    [SerializeField]
    private AudioClip[] _accelerationSounds = null;
    [SerializeField]
    private AudioClip[] _decelerationSounds = null;
    [SerializeField]
    private AudioClip _startUpSound = null;

    [SerializeField]
    private AudioSource _smokeStackAudioSource = null;
    [SerializeField]
    private AudioClip _smokeSound = null;

    [SerializeField]
    private ParticleSystem _smoke1 = null;
    [SerializeField]
    private ParticleSystem _smoke2 = null;
    [SerializeField]
    private TrainCarBase[] _childCars = null;
    ...
    private void UpdateSmokeEmissionBasedOnSpeed()
    {
      ...
      var mainModule = _smoke1.main;
      mainModule.maxParticles = (int)Mathf.Lerp(
          _standardMaxParticles,
    ...
    {
      return Mathf.Lerp(
          _standardRateOverTimeMultiplier,
          _standardRateOverTimeMultiplier * SMOKE_SPEED_MULTIPLIER,
          _currentSpeed / (MAX_SPEED - MIN_SPEED)
      );
    }
