...
namespace OculusSampleFramework
{
  public class WindmillController : MonoBehaviour
  {
    ...
    {
      _startStopButton.GetComponent<Interactable>()
          .InteractableStateChanged.AddListener(StartStopStateChanged);
    }
    ...
    private void OnDisable()
    {
      ...
      {
        _startStopButton.GetComponent<Interactable>()
            .InteractableStateChanged.RemoveListener(StartStopStateChanged);
      }
    }
    ...
    private void StartStopStateChanged(InteractableStateArgs obj)
    {
      ...
      _toolInteractingWithMe =
          obj.NewInteractableState > InteractableState.Default ? obj.Tool : null;
    }
      ...
      else
      {
        _selectionCylinder.CurrSelectionState =
            (
                ...
                || _toolInteractingWithMe.ToolInputState
                    == ToolInputState.PrimaryInputDownStay
            )
