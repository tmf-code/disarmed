...
namespace OculusSampleFramework
{
  ...
  public class TrainButtonVisualController : MonoBehaviour
  {
    ...
    [SerializeField]
    private MeshRenderer _glowRenderer = null;
    [SerializeField]
    private ButtonController _buttonController = null;
    [SerializeField]
    private Color _buttonContactColor = new Color(0.51f, 0.78f, 0.92f, 1.0f);
    [SerializeField]
    private Color _buttonActionColor = new Color(0.24f, 0.72f, 0.98f, 1.0f);

    [SerializeField]
    private AudioSource _audioSource = null;
    [SerializeField]
    private AudioClip _actionSoundEffect = null;

    [SerializeField]
    private Transform _buttonContactTransform = null;
    [SerializeField]
    ...
    private void ActionOrInContactZoneStayEvent(ColliderZoneArgs collisionArgs)
    {
      ...
      if (
          scaledLocalSpaceOffset > -_contactMaxDisplacementDistance
          && scaledLocalSpaceOffset <= 0.0f
      )
      {
        transform.localPosition = new Vector3(
            _oldPosition.x,
            _oldPosition.y + scaledLocalSpaceOffset,
            _oldPosition.z
        );
      }
    }
    ...
    {
      _buttonInContactOrActionStates = false;
      _glowRenderer.gameObject.SetActive(
