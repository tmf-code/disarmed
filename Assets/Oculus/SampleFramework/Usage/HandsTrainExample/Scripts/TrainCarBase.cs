...
namespace OculusSampleFramework
{
  public abstract class TrainCarBase : MonoBehaviour
  {
    ...
    [SerializeField]
    protected Transform _frontWheels = null;
    [SerializeField]
    protected Transform _rearWheels = null;
    [SerializeField]
    protected TrainTrack _trainTrack = null;
    [SerializeField]
    protected Transform[] _individualWheels = null;
    ...
    protected void RotateCarWheels()
    {
      ...
      {
        individualWheel.localRotation = Quaternion.AngleAxis(
            Mathf.Rad2Deg * angleOfRot,
            Vector3.right
        );
      }
    }
