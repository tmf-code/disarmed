...
public class CharacterCameraConstraint : MonoBehaviour
{
  ...
  private void CameraUpdate()
  {
    ...
    float calculatedHeight =
        CameraRig.centerEyeAnchor.localPosition.y + HeightOffset + capsuleOffset;
    ...
    if (
        Physics.SphereCast(
            ...
            _character.radius * 0.2f,
            Vector3.up,
            out heightHitInfo,
            MaximumHeight - _character.transform.position.y,
            CollideLayers,
    ...
    _character.height = Mathf.Clamp(
        calculatedHeight,
        calculatedMinimumHeight,
        calculatedMaximumHeight
    );
  ...
  private bool CheckCameraOverlapped()
  {
    ...
    origin.y = Mathf.Clamp(
        CameraRig.centerEyeAnchor.position.y,
  ...
  private bool CheckCameraNearClipping(out float result)
  {
    ...
    result = 0.0f;
    foreach (
        Vector3 frustumPoint in new Vector3[]
        {
                frustumBottomLeft,
                frustumTopLeft,
                frustumTopRight,
