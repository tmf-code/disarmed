...
public class TeleportInputHandlerTouch : TeleportInputHandlerHMD
{
  ...
  /// </summary>
  [Tooltip(
      "Select the controller to be used for aiming. Supports LTouch, RTouch, or Touch for either."
  )]
  ...
  /// </summary>
  [Tooltip(
      "Select the button to use for triggering aim and teleport when InputMode==CapacitiveButtonForAimAndTeleport"
  )]
  ...
  public override LocomotionTeleport.TeleportIntentions GetIntention()
  {
    ...
    if (
        ...
        || InputMode == InputModes.ThumbstickTeleportForwardBackOnly
    )
    {
      ...
      bool touching =
          bestMag > ThumbstickTeleportThreshold
      ...
      if (!touching)
      {
        ...
        if (
            LocomotionTeleport.CurrentIntention
            == LocomotionTeleport.TeleportIntentions.PreTeleport
        )
        {
    ...
    // If the user is already in the PreTeleport state, the intention will be to either remain in this state or switch to Teleport
    if (
        LocomotionTeleport.CurrentIntention == LocomotionTeleport.TeleportIntentions.PreTeleport
    )
    {
