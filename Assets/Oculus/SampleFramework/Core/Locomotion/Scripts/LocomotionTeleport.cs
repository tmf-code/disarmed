...
public class LocomotionTeleport : MonoBehaviour
{
  ...
  public void OnUpdateTeleportDestination(
      ...
      case AimCollisionTypes.Capsule:
        {
          ...
          return Physics.CapsuleCast(
              start + new Vector3(0, r, 0),
              start + new Vector3(0, h + r, 0),
              r,
              direction,
              out hitInfo,
              distance,
  ...
  protected IEnumerator AimStateCoroutine()
  {
    ...
    if (
        (
            CurrentIntention == TeleportIntentions.PreTeleport
            || CurrentIntention == TeleportIntentions.Teleport
  ...
  public Quaternion GetHeadRotationY()
  {
    ...
    UnityEngine.XR.InputDevice device = UnityEngine.XR.InputDevices.GetDeviceAtXRNode(
