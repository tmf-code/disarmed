...
public class TeleportDestination : MonoBehaviour
{
  ...
  [Tooltip(
      "If the target handler provides a target position, this transform will be moved to that position and it's game object enabled. A target position being provided does not mean the position is valid, only that the aim handler found something to test as a destination."
  )]
  ...
  private readonly Action<
      ...
      Quaternion?,
      Quaternion?
  > _updateTeleportDestinationAction;
  ...
  public virtual void UpdateTeleportDestination(
