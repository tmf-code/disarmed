...
public static class NativeVideoPlayer
{
  ...
  private static System.IntPtr VideoPlayerClass
  {
    get
    {
      if (!_VideoPlayerClass.HasValue)
      {
        try
        {
          System.IntPtr myVideoPlayerClass = AndroidJNI.FindClass(
              "com/oculus/videoplayer/NativeVideoPlayer"
          );
  ...
  private static System.IntPtr Activity
  {
    get
    {
      if (!_Activity.HasValue)
      {
        try
        {
          System.IntPtr unityPlayerClass = AndroidJNI.FindClass(
              "com/unity3d/player/UnityPlayer"
          );
          System.IntPtr currentActivityField = AndroidJNI.GetStaticFieldID(
              unityPlayerClass,
              "currentActivity",
              "Landroid/app/Activity;"
          );
          System.IntPtr activity = AndroidJNI.GetStaticObjectField(
              unityPlayerClass,
  ...
  public static bool IsPlaying
  {
    get
    {
      ...
      {
        getIsPlayingMethodId = AndroidJNI.GetStaticMethodID(
            VideoPlayerClass,
            "getIsPlaying",
            "()Z"
        );
      ...
      return AndroidJNI.CallStaticBooleanMethod(
          VideoPlayerClass,
          getIsPlayingMethodId,
          EmptyParams
      );
    }
  }
  ...
  public static PlabackState CurrentPlaybackState
  {
    get
    {
      ...
      {
        getCurrentPlaybackStateMethodId = AndroidJNI.GetStaticMethodID(
            VideoPlayerClass,
      ...
      return (PlabackState)AndroidJNI.CallStaticIntMethod(
          VideoPlayerClass,
  ...
  public static long Duration
  {
    get
    {
      ...
      {
        getDurationMethodId = AndroidJNI.GetStaticMethodID(
            VideoPlayerClass,
            "getDuration",
            "()J"
        );
      ...
      return AndroidJNI.CallStaticLongMethod(
          VideoPlayerClass,
          getDurationMethodId,
          EmptyParams
      );
  ...
  public static StereoMode VideoStereoMode
  {
    get
    {
      ...
      {
        getStereoModeMethodId = AndroidJNI.GetStaticMethodID(
            VideoPlayerClass,
            "getStereoMode",
            "()I"
        );
      ...
      return (StereoMode)AndroidJNI.CallStaticIntMethod(
          VideoPlayerClass,
          getStereoModeMethodId,
          EmptyParams
      );
    }
  }
  ...
  public static int VideoWidth
  {
    get
    {
      ...
      {
        getWidthMethodId = AndroidJNI.GetStaticMethodID(
            VideoPlayerClass,
            "getWidth",
            "()I"
        );
  ...
  public static int VideoHeight
  {
    get
    {
      ...
      {
        getHeightMethodId = AndroidJNI.GetStaticMethodID(
            VideoPlayerClass,
            "getHeight",
            "()I"
        );
  ...
  public static long PlaybackPosition
  {
    get
    {
      ...
      {
        getPlaybackPositionMethodId = AndroidJNI.GetStaticMethodID(
            VideoPlayerClass,
            "getPlaybackPosition",
            "()J"
        );
    ...
    set
    {
      ...
      {
        setPlaybackPositionMethodId = AndroidJNI.GetStaticMethodID(
            VideoPlayerClass,
            "setPlaybackPosition",
            "(J)V"
        );
  ...
  public static void PlayVideo(string path, string drmLicenseUrl, System.IntPtr surfaceObj)
  {
    ...
    {
      playVideoMethodId = AndroidJNI.GetStaticMethodID(
          VideoPlayerClass,
          "playVideo",
  ...
  public static void SetPlaybackSpeed(float speed)
  {
    ...
    {
      setPlaybackSpeedMethodId = AndroidJNI.GetStaticMethodID(
          VideoPlayerClass,
          "setPlaybackSpeed",
          "(F)V"
      );
  ...
  public static void SetLooping(bool looping)
  {
    ...
    {
      setLoopingMethodId = AndroidJNI.GetStaticMethodID(
          VideoPlayerClass,
          "setLooping",
          "(Z)V"
      );
  ...
  public static void SetListenerRotation(Quaternion rotation)
  {
    ...
    {
      setListenerRotationQuaternionMethodId = AndroidJNI.GetStaticMethodID(
          VideoPlayerClass,
          "setListenerRotationQuaternion",
          "(FFFF)V"
      );
