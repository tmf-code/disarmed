...
namespace OVRTouchSample
{
  ...
  public class Hand : MonoBehaviour
  {
    ...
    private void Start()
    {
      ...
      OVRPlugin.SendEvent(
          "custom_hand",
          (SceneManager.GetActiveScene().name == "CustomHands").ToString(),
          "sample_framework"
      );
#endif
    }
    ...
    private void Update()
    {
      ...
      bool collisionEnabled =
          m_grabber.grabbedObject == null && flex >= THRESH_COLLISION_FLEX;
    ...
    private void UpdateCapTouchStates()
    {
      ...
      m_isGivingThumbsUp = !OVRInput.Get(
          OVRInput.NearTouch.PrimaryThumbButtons,
          m_controller
      );
    }
    ...
    private void LateUpdate()
    {
      ...
      {
        m_collisionScaleCurrent = Mathf.Min(
            COLLIDER_SCALE_MAX,
