...
namespace OculusSampleFramework
{
  ...
  {
    [SerializeField]
    private Transform[] LeftHandTools = null;
    [SerializeField]
    private Transform[] RightHandTools = null;
    ...
    private IEnumerator AttachToolsToHands(Transform[] toolObjects, bool isRightHand)
    {
      ...
      while (
          (handsManagerObj = HandsManager.Instance) == null
          || !handsManagerObj.IsInitialized()
      )
      {
        yield return null;
      }
      ...
      {
        OVRSkeleton handSkeletonToAttachTo = isRightHand
            ? handsManagerObj.RightHandSkeleton
            : handsManagerObj.LeftHandSkeleton;
