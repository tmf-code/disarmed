...
namespace OculusSampleFramework
{
  public class HandsManager : MonoBehaviour
  {
    ...
    [SerializeField]
    GameObject _leftHand = null;
    [SerializeField]
    GameObject _rightHand = null;
    ...
    private OVRSkeletonRenderer[] _handSkeletonRenderer = new OVRSkeletonRenderer[
        (int)OVRHand.Hand.HandRight + 1
    ];
    private OVRMesh[] _handMesh = new OVRMesh[(int)OVRHand.Hand.HandRight + 1];
    private OVRMeshRenderer[] _handMeshRenderer = new OVRMeshRenderer[
        (int)OVRHand.Hand.HandRight + 1
    ];
    ...
    private IEnumerator FindSkeletonVisualGameObjects()
    {
      while (!_leftSkeletonVisual || !_rightSkeletonVisual)
      {
        ...
        {
          Transform leftSkeletonVisualTransform = LeftHand.transform.Find(
              SKELETON_VISUALIZER_NAME
          );
        ...
        {
          Transform rightSkeletonVisualTransform = RightHand.transform.Find(
              SKELETON_VISUALIZER_NAME
          );
    ...
    public bool IsInitialized()
    {
      return LeftHandSkeleton
          && LeftHandSkeleton.IsInitialized
          && RightHandSkeleton
          && RightHandSkeleton.IsInitialized
          && LeftHandMesh
          && LeftHandMesh.IsInitialized
          && RightHandMesh
          && RightHandMesh.IsInitialized;
    }
  }
}
