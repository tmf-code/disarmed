...
namespace OculusSampleFramework
{
  ...
  public class FingerTipPokeTool : InteractableTool
  {
    ...
    private IEnumerator AttachTriggerLogic()
    {
      ...
      List<BoneCapsuleTriggerLogic> boneCapsuleTriggerLogic =
          new List<BoneCapsuleTriggerLogic>();
      List<OVRBoneCapsule> boneCapsules = HandsManager.GetCapsulesPerBone(
          handSkeleton,
          boneToTestCollisions
      );
    ...
    private void Update()
    {
      if (
          ...
          || !HandsManager.Instance.IsInitialized()
          || !_isInitialized
      ...
      OVRHand hand = IsRightHandedTool
          ? HandsManager.Instance.RightHand
          : HandsManager.Instance.LeftHand;
      ...
      Vector3 capsuleTipPosition =
          capsuleTransform.position
          + _capsuleToTrack.CapsuleCollider.height * 0.5f * capsuleDirection;
      Vector3 toolSphereRadiusOffsetFromTip =
          currentScale * _fingerTipPokeToolView.SphereRadius * capsuleDirection;
    ...
    private void UpdateAverageVelocity()
    {
      ...
      int numFramesToSamples = _sampledMaxFramesAlready
          ? NUM_VELOCITY_FRAMES
          : _currVelocityFrame + 1;
    ...
    public override List<InteractableCollisionInfo> GetNextIntersectingObjects()
    {
      ...
      foreach (var boneCapsuleTriggerLogic in _boneCapsuleTriggerLogic)
      {
        ...
        {
          _currentIntersectingObjects.Add(
              new InteractableCollisionInfo(
                  colliderTouching,
                  colliderTouching.CollisionDepth,
                  this
              )
          );
        }
    ...
    public override void FocusOnInteractable(
