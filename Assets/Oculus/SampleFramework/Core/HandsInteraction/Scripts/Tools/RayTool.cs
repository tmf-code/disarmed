...
namespace OculusSampleFramework
{
  ...
  public class RayTool : InteractableTool
  {
    ...
    [SerializeField]
    private RayToolView _rayToolView = null;
    [Range(0.0f, 45.0f)]
    [SerializeField]
    private float _coneAngleDegrees = 20.0f;
    [SerializeField]
    private float _farFieldMaxDistance = 5f;

    public override InteractableToolTags ToolTags
    {
      get { return InteractableToolTags.Ray; }
    }
    ...
    {
      get { return _rayToolView.EnableState; }
    ...
    private void Update()
    {
      ...
      _rayToolView.ToolActivateState =
          _pinchStateModule.PinchSteadyOnFocusedObject
        ...
        if (_currInteractableCastedAgainst != null)
        {
          ...
          for (int i = 0; i < numHits; i++)
          {
            ...
            if (
                ...
                || interactableComponent != _currInteractableCastedAgainst
            )
            {
              continue;
            }

            InteractableCollisionInfo collisionInfo = new InteractableCollisionInfo(
                colliderZone,
                colliderZone.CollisionDepth,
                this
            );
    ...
    private Interactable FindPrimaryRaycastHit(Vector3 rayOrigin, Vector3 rayDirection)
    {
      ...
      for (int hitIndex = 0; hitIndex < numHits; hitIndex++)
      {
        ...
        if (
            ...
            || (currentInteractable.ValidToolTagsMask & (int)ToolTags) == 0
        )
        {
          continue;
        }
