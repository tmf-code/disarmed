...
namespace OculusSampleFramework
{
  ...
  public class ButtonController : Interactable
  {
    ...
    [SerializeField]
    private GameObject _proximityZone = null;
    [SerializeField]
    private GameObject _contactZone = null;
    [SerializeField]
    private GameObject _actionZone = null;
    [SerializeField]
    private ContactTest[] _contactTests = null;
    // for positive side tests, the contact position must be on the positive side of the plane
    // determined by this transform
    [SerializeField]
    private Transform _buttonPlaneCenter = null;
    ...
    private Dictionary<InteractableTool, InteractableState> _toolToState = new Dictionary<
        InteractableTool,
        InteractableState
    >();
    ...
    private void FireInteractionEventsOnDepth(
        InteractableCollisionDepth oldDepth,
    ...
    public override void UpdateCollisionDepth(
    ...
    )
    {
      ...
      bool testForSingleToolInteraction =
          !isFarFieldTool && !_allowMultipleNearFieldInteraction;
      if (
          testForSingleToolInteraction
          && _toolToState.Keys.Count > 0
      ...
      bool validContact =
          IsValidContact(interactableTool, currButtonDirection)
      ...
      {
        upcomingState = toolInContactZone
      ...
      else
      {
        ...
        bool onPositiveSideOfButton =
            !_makeSureToolIsOnPositiveSide
            || buttonZonePlane.GetSide(interactableTool.InteractionPosition);
        upcomingState = GetUpcomingStateNearField(
            oldState,
            newCollisionDepth,
            toolInActionZone,
            toolInContactZone,
      ...
      bool setMaxStateForAllTools = isFarFieldTool || _allowMultipleNearFieldInteraction;
      ...
      if (oldState != upcomingState)
      {
        ...
        var interactionType = !switchingStates
            ? InteractionType.Stay
            : newCollisionDepth == InteractableCollisionDepth.None
                ? InteractionType.Exit
                : InteractionType.Enter;
        ...
        InteractableStateChanged?.Invoke(
            new InteractableStateArgs(
                this,
                interactableTool,
                CurrentButtonState,
                oldState,
    ...
    private InteractableState GetUpcomingStateNearField(
        InteractableState oldState,
        InteractableCollisionDepth newCollisionDepth,
        bool toolIsInActionZone,
        bool toolIsInContactZone,
        bool toolIsInProximity,
        bool validContact,
    ...
    )
    {
      ...
      switch (oldState)
      {
        ...
        case InteractableState.ContactState:
          ...
          {
            upcomingState = toolIsInProximity
                ? InteractableState.ProximityState
                : InteractableState.Default;
          }
        ...
        case InteractableState.ProximityState:
          if (newCollisionDepth < InteractableCollisionDepth.Proximity)
          {
            upcomingState = InteractableState.Default;
              ...
              validContact
              && onPositiveSideOfInteractable
              && newCollisionDepth > InteractableCollisionDepth.Proximity
          )
          {
            upcomingState =
                newCollisionDepth == InteractableCollisionDepth.Action
