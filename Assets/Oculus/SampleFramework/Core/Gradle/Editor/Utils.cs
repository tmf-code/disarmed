...
namespace Gradle
{
  public static class Configuration
  {
    ...
    private static readonly string gradleTemplatePath =
        androidPluginsFolder + "mainTemplate.gradle";
    private static readonly string disabledGradleTemplatePath =
        gradleTemplatePath + ".DISABLED";
    private static readonly string internalGradleTemplatePath = Path.Combine(
        Path.Combine(GetBuildToolsDirectory(BuildTarget.Android), "GradleTemplates"),
        "mainTemplate.gradle"
    );
    ...
    {
      return (string)(
          typeof(BuildPipeline).GetMethod(
  ...
  public static class Dependencies
  {
    ...
    public static void AddDependency(string name, string version, List<string> lines)
    {
      ...
      {
        lines.Insert(
            Gradle.Parsing.GetScopeEnd(dependencies + 1, lines),
