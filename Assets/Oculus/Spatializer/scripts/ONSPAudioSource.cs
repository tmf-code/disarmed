...
public class ONSPAudioSource : MonoBehaviour
{
  ...
  [DllImport(strONSPS)]
  private static extern void ONSP_GetGlobalRoomReflectionValues(
      ref bool reflOn,
      ref bool reverbOn,
      ref float width,
      ref float height,
  ...
  void Update()
  {
    ...
    // READ-ONLY PARAMETER TEST
        ...
        String readOnly = System.String.Format(
            "Read only values: refl enabled: {0:F0} num voices: {1:F0}",
            rfl_enabled,
            num_voices
        );
        Debug.Log(readOnly);
  ...
  void OnDrawGizmos()
  {
    ...
    if (RoomReflectionGizmoAS == this)
    {
      ...
      ONSP_GetGlobalRoomReflectionValues(
          ref reflOn,
          ref reverbOn,
          ref width,
          ref height,
