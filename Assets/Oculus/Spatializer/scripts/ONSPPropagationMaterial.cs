...
public sealed class ONSPPropagationMaterial : MonoBehaviour
{
    ...
    public float this[float f]
    {
      get
      {
        if (points.Count > 0)
        {
          ...
          return lower.data
              + (f - lower.frequency) * (upper.data - lower.data)
  ...
  public void StartInternal()
  {
    ...
    if (
        ONSPPropagation.Interface.CreateAudioMaterial(out materialHandle)
        != ONSPPropagationGeometry.OSPSuccess
    )
  ...
  public void UploadMaterial()
  {
    ...
    foreach (Point p in absorption.points)
      ONSPPropagation.Interface.AudioMaterialSetFrequency(
          materialHandle,
          MaterialProperty.ABSORPTION,
          p.frequency,
          p.data
      );
    ...
    material.transmission.points = new List<Point>()
        {
            ...
            new Point(500f, .03f),
            new Point(1000f, .02f),
            new Point(2000f, .005f),
            new Point(4000f, .002f)
        };
  }
    ...
    material.transmission.points = new List<Point>()
        {
            ...
            new Point(250f, .019f),
            new Point(500f, .01f),
            new Point(1000f, .0045f),
            new Point(2000f, .0018f),
            new Point(4000f, .00089f)
        };
  }
  ...
  private static void Carpet(ref ONSPPropagationMaterial material)
  {
    ...
    material.transmission.points = new List<Point>()
        {
            new Point(125f, .004f),
            new Point(250f, .0079f),
            new Point(500f, .0056f),
            new Point(1000f, .0016f),
            new Point(2000f, .0014f),
            new Point(4000f, .0005f)
        };
  }
    ...
    material.transmission.points = new List<Point>()
        {
            new Point(125f, .02f),
            new Point(250f, .01f),
            new Point(500f, .0063f),
            new Point(1000f, .0035f),
            new Point(2000f, .00011f),
            new Point(4000f, .00063f)
        };
  }
    ...
    material.transmission.points = new List<Point>()
        {
            ...
            new Point(500f, .21f),
            new Point(1000f, .14f),
            new Point(2000f, .079f),
            new Point(4000f, .045f)
        };
  }
    ...
    material.transmission.points = new List<Point>()
        {
            ...
            new Point(250f, .089f),
            new Point(500f, .05f),
            new Point(1000f, .028f),
            new Point(2000f, .022f),
            new Point(4000f, .079f)
        };
  }
    ...
    material.transmission.points = new List<Point>()
        {
            ...
            new Point(500f, .028f),
            new Point(1000f, .02f),
            new Point(2000f, .032f),
            new Point(4000f, .014f)
        };
  }
  ...
  private static void GypsumBoard(ref ONSPPropagationMaterial material)
  {
    ...
    material.transmission.points = new List<Point>()
        {
            new Point(125f, .035f),
            new Point(250f, .0125f),
            new Point(500f, .0056f),
            new Point(1000f, .0025f),
            new Point(2000f, .0013f),
            new Point(4000f, .0032f)
        };
  }
    ...
    material.transmission.points = new List<Point>()
        {
            ...
            new Point(250f, .2f),
            new Point(500f, .17f),
            new Point(1000f, .089f),
            new Point(2000f, .089f),
            new Point(4000f, .0056f)
        };
  }
    ...
    material.transmission.points = new List<Point>()
        {
            ...
            new Point(500f, .028f),
            new Point(1000f, .028f),
            new Point(2000f, .011f),
            new Point(4000f, .0071f)
        };
  }
    ...
    material.transmission.points = new List<Point>()
        {
            new Point(125f, .071f),
            new Point(250f, .025f),
            new Point(500f, .0158f),
            new Point(1000f, .0056f),
            new Point(2000f, .0035f),
            new Point(4000f, .0016f)
        };
  }
